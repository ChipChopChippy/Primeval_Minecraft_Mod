...
public class EntityDeinonychusMob extends EntityZombie {

	public EntityDeinonychusMob(World world) {
		super(world);
	...
	// return new EntityDeinonychusMob(worldObj);
	// }
	/**
	...
	protected String getLivingSound() {
		return "modid:mob.deinonychus.say";
	}
